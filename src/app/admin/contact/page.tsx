...
const ContactAdminPage = () => {
  const [contactImage, setContactImage] = useState('/images/contact.jpg');

  const handleContactImageUpdate = async (file: File) => {
    try {
      ...
      <div className="space-y-8">
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          ...
          <div className="space-y-6">
            ...
            {/* Diğer İletişim bölümü öğeleri buraya eklenebilir */}
          </div>
        </div>
      </div>
    </>
